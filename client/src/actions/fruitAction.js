...
export const getAllfruits = () => async dispatch => {
  ...
  try {
    const response = await axios.get('https://freshmart-backend.vercel.app/api/fruits');
...
export const getFruitById = (fruitid) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://freshmart-backend.vercel.app/api/fruits/getfruitbyid/${fruitid}`);
...
export const addFruit=(fruit)=> async dispatch=>{
  ...
  try {
    const response=await axios.post('https://freshmart-backend.vercel.app/api/fruits/addfruit',{fruit})
...
export const editfruit = (editedfruit) => async dispatch => {
  ...
  try {
    const response = await axios.post('https://freshmart-backend.vercel.app/api/fruits/editfruit',{editedfruit});
    console.log(response);
...
export const deleteFruit=(fruitid)=>async dispatch=>{
  try{
    const response=await axios.post('https://freshmart-backend.vercel.app/api/fruits/deletefruit',{fruitid})
